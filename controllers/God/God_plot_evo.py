...
class God:
    ...
    def selection(self):
        ...
        print("The top one is the #" + str(self.scores.index(maximum)) + " scored: " + str(max(self.scores)))
        fitness_file = self.open_motion_file(self.population_folder + "fitness.txt")
        fitness_file.append([str(self.n_generation), str(maximum)])
        self.close_motion_file(fitness_file, self.population_folder + "fitness.txt")
